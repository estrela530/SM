...
namespace SMGame.Character.Legs
{
    class Leg3 : LegsManager
    {
            ...
            : base("leg-root-back", "leg-tip-back")
        {
            ...
            position = new Vector2(250, Screen.Height / 2 - 100);
        ...
        public void Attack()
        {
            ...
            switch (isAttack)
            {
                ...
                case 2://攻撃
                    position.X -= 4f;
                    position.Y += 4f;
                    tipRotate += (SetRotate(position, new Vector2(0, Screen.Height)) - MathHelper.ToRadians(90) - tipRotate) / 25;
                ...
                case 5:
                    position.X -= 4f;
                    position.Y += 4f;
                    tipRotate += (SetRotate(position, new Vector2(700, Screen.Height)) - MathHelper.ToRadians(90) - tipRotate) / 25;
                    if (position.X < rootPosition.X - rootTextureSize.X)
                    {
                        position.X = rootPosition.X - rootTextureSize.X;
                    }
        ...
        public override void GetPlayer(Player player)
        {
            this.player = player;
        }
